...
class ExpressReceiver {
    ...
    async requestHandler(req, res) {
        ...
        let timer = setTimeout(() => {
            var _a;
            (_a = this.bolt) === null || _a === void 0 ? void 0 : _a.handleError(new errors_1.ReceiverAuthenticityError('An incoming event was not acknowledged before the timeout. ' +
...
function verifySignatureAndParseRawBody(logger, signingSecret) {
    return async (req, res, next) => {
        ...
        try {
            ...
            req.body = receiver_1.verifySignatureAndParseBody(signingSecret, stringBody, req.headers);
        }
        catch (error) {
            if (error) {
